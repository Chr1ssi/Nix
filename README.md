...
- PipeWire
- EasyEffects mit dem Eingabe-Preset `Wave3 Clean`
- xdg-desktop-portals
- Polkit-Agent
- Benachrichtigungen
- Screen Lock
...
- Vesktop
- GameMode
- GOverlay (inklusive MangoHud)
- notwendige 32-Bit-Grafikunterstützung

GameMode kann Spielen temporär optimierte Systemressourcen zur Verfügung stellen.

GOverlay dient zur Konfiguration von MangoHud. MangoHud wird dabei bereits als
Laufzeitabhängigkeit von GOverlay mitgeliefert und zeigt Performance-Informationen
wie FPS, Frametimes und Hardwareauslastung an. Die bestehende MangoHud- und
GOverlay-Konfiguration wird beim ersten Home-Manager-Lauf als beschreibbarer
Startwert übernommen, damit spätere Änderungen über GOverlay möglich bleiben.
...
*** Add File: /home/chris/Projects/nixos/dotfiles/MangoHud/MangoHud.conf
################### File Generated by Goverlay 1.9.2 stable ###################
legacy_layout=0
...
fps_limit=0
output_folder=/home/chris/.local/share/goverlay
log_interval=100
